 ...
 */
{
	...
	const settings = {
		...
		pagination: { duration: 100, delay: 200, easing: 'easeInOutQuad' },
		...
		updatePageNumber(oldPos) {
			...
			anime({
				...
				complete: () => {
					...
					this.DOM.planImages[oldPos].style.display = 'none';
					this.DOM.planImages[oldPos].style.opacity = 0;
					this.DOM.planImages[this.currentPos].style.display = 'inline';
					anime({
						targets: this.DOM.planImages[this.currentPos],
						opacity: '1',
						duration: 300,
						easing: 'easeInOutQuad',
						begin: () => {
